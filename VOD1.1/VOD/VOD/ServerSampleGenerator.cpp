...
std::vector< std::vector<char> > ServerSampleGenerator::GenerateServerSample(IplImage *src, int imgCentrex, int imgCentrey, int imgCentrexWidth, int imgCentreHeigh)
{
	...
	fingerprintSamples.push_back(fg.GenerateFingerprint(src, FingerPosition[0]));
	//for(int m=1; m<=5; m++)
	//{
